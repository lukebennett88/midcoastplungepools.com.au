...
const StyleSamplePage = () => (
  <Layout>
    <SEO title="Style Sample" keywords={[`gatsby`, `application`, `react`]} />
      ...
      <article className="max-w-md w-full">
        ...
        <div>
          ...
          <p>
            ...
            Don’t forget some nice “curly quotes” (not all fonts have these, so
          ...
          <p>
            ...
            <code>code text</code>? This should be in a monospace font.
          </p>
          <p>
            You might also want to do syntax highlighting, so here is a block of
            javascript for you to layout.
          </p>
          <div className="gatsby-highlight" data-language="js">
            <pre>
              <code>
                ...
                {'\n'}
                <span>var</span> <span>fun</span> <span>=</span>{' '}
                <span>function</span> <span>lang</span>
                <span>(</span>l<span>)</span> <span>{'{'}</span>
                {'\n'}
                {'  '}dateformat<span>.</span>
                i18n <span>=</span> <span>require</span>
                <span>(</span>
                <span>"./lang/"</span> <span>+</span> l<span>)</span>
                <span>;</span>
                {'\n'}
                {'  '}
          ...
          <blockquote>
            ...
            <p>
              I’ll add a second paragraph here that is long enough to cause line
              wrapping. Once again, check for padding and margin, font size etc.
            </p>
          </blockquote>
          ...
          <p>
            Further paragraphs of text. And yet more text. A bit more text too,
            for good measure.
          </p>
          <p>
            Further paragraphs of text. And yet more text. A bit more text too,
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  guitar, lap steel guitar, keyboards, synthesizers, percussion,
                  backing vocals, bass
                </td>
                <td>2002 – present</td>
              </tr>
